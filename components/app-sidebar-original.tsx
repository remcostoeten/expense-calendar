...
import { etiquettes } from "@/features/calendar/components/big-calendar"
...
import SidebarCalendar from "@/features/sidebar-calendar"
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <>
      <IconSidebar />
      <Sidebar variant="inset" {...props} className="dark scheme-only-dark max-lg:p-3 lg:pe-1 pl-16">
        <SidebarHeader>
