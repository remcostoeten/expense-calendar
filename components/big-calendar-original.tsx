...
import { type TCalendarEvent, EventCalendar } from "@/features/calendar/components/event-calendar"
...
const sampleEvents: TCalendarEvent[] = [
  {
    id: "w1-0a",
...
export default function Component() {
  const [events, setEvents] = useState<TCalendarEvent[]>(sampleEvents)
